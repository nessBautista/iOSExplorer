...
let mySerialQueue = DispatchQueue(label: "com.lab.serial")
...
let workerQueue = DispatchQueue(label: "com.lab.worker", attributes: .concurrent)
...
// TODO
//dispatchPrecondition(condition: .notOnQueue(mainQueue)) // will stop running becase we are on the main queue
